...
@Data
@NoArgsConstructor
public class Brazalete_alquilado implements Brazalete {

    private int serial_brazalete = 0;
    private Turno turno;
    private FormaPago forma_de_pago;
    private final Condicion condicion = Condicion.ALQUILADO;
    ...
    private final boolean representa_ingreso = true;

    public Brazalete_alquilado(String responsable, String inmueble) {
